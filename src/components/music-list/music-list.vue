<template>
    <div class="music-list">
        ...
        <scroll class="list" :data="songs" ref="list" :listenScroll="listenScroll" :probe-type="probeType" @scroll="scroll">
...
export default {
  ...
  mounted() {
    ...
    this.minTranslateY = -this.imageHeight + RESERVED_HEIGHT; //layer向上滑的最大距离
